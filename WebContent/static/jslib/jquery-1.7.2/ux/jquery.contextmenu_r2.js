...
(function($) {
	...
	$.fn.contextMenu = function(id, options) {
		...
		prepareDom(this, id, options.items);
	...
	function prepareDom(container, id, items) {
		var dom = $('<div class="contextMenu" style="position:absolute;display:none;" id="'
				+ id + '"></div>');
	...
	function display(index, trigger, e, options) {
		...
		$.each(cur.items, function(id, item) {
					$('#' + id, menu).bind('click', function(e) {
								hide();
								item.func(trigger, currentTarget);
							});
				});
		menu.css({
