...
function(t, e, i) {
	...
	L.Draw.Polyline = L.Draw.Feature.extend({
		...
		_endPoint: function(e, i, o) {
			if (this._mouseDownOrigin) {
				...
				this._calculateFinishDistance(o.latlng) < 10 && L.Browser.touch ? this._finishShape() : Math.abs(n) < 9 * (t.devicePixelRatio || 1) && this.addVertex(o.latlng),
				this._enableNewMarkers()
			}
			this._mouseDownOrigin = null
		},
		_onTouch: function(t) {
			var e, i, o = t.originalEvent; ! o.touches || !o.touches[0] || this._clickHandled || this._touchHandled || this._disableMarkers || (e = o.touches[0].clientX, i = o.touches[0].clientY, this._disableNewMarkers(), this._touchHandled = !0, this._startPoint.call(this, e, i), this._endPoint.call(this, e, i, t), this._touchHandled = null),
			this._clickHandled = null
		},
		...
		_drawGuide: function(t, e) {
			...
			l = s > r ? s - r: a;
			for (this._guidesContainer || (this._guidesContainer = L.DomUtil.create("div", "leaflet-draw-guides", this._overlayPane)); l < s; l += this.options.guidelineDistance) i = l / s,
			o = {
		...
		_updateGuideColor: function(t) {
			...
			i = this._guidesContainer.childNodes.length; e < i; e++) this._guidesContainer.childNodes[e].style.backgroundColor = t
		},
		...
		_getMeasurementString: function() {
			...
			return t = i && e && e.distanceTo ? this._measurementRunningTotal + e.distanceTo(i) : this._measurementRunningTotal || 0,
	...
	L.Draw.SimpleShape = L.Draw.Feature.extend({
		...
		removeHooks: function() {
			L.Draw.Feature.prototype.removeHooks.call(this),
			this._map && (this._mapDraggable && this._map.dragging.enable(), this._container.style.cursor = "", this._map.off("mousedown", this._onMouseDown, this).off("mousemove", this._onMouseMove, this).off("touchstart", this._onMouseDown, this).off("touchmove", this._onMouseMove, this), L.DomEvent.off(e, "mouseup", this._onMouseUp, this), L.DomEvent.off(e, "touchend", this._onMouseUp, this), this._shape && (this._map.removeLayer(this._shape), delete this._shape)),
			this._isDrawing = !1
		},
		_getTooltipText: function() {
			return {
	...
	L.Edit.PolyVerticesEdit = L.Handler.extend({
		...
		initialize: function(t, e, i) {
			L.Browser.touch && (this.options.icon = this.options.touchIcon),
			this._poly = t,
			i && i.drawError && (i.drawError = L.Util.extend({},
		...
		_initMarkers: function() {
			...
			for (t = 0, i = n.length; t < i; t++) o = this._createMarker(n[t], t),
	...
	L.Polyline.addInitHook(function() {
		this.editing || (L.Edit.Poly && (this.editing = new L.Edit.Poly(this, this.options.poly), this.options.editable && this.editing.enable()), this.on("add",
		function() {
	...
	L.Edit.SimpleShape = L.Handler.extend({
		...
		removeHooks: function() {
			...
			if (t.setStyle(t.options.original), t._map) {
				...
				for (var e = 0,
				i = this._resizeMarkers.length; e < i; e++) this._unbindMarker(this._resizeMarkers[e]);
	...
	L.Edit.Rectangle = L.Edit.SimpleShape.extend({
		...
		_createResizeMarker: function() {
			...
			this._resizeMarkers = [];
			for (var e = 0,
			i = t.length; e < i; e++) this._resizeMarkers.push(this._createMarker(t[e], this.options.resizeIcon)),
		...
		_move: function(t) {
			for (var e, i = this._shape._defaultShape ? this._shape._defaultShape() : this._shape.getLatLngs(), o = this._shape.getBounds(), n = o.getCenter(), s = [], a = 0, r = i.length; a < r; a++) e = [i[a].lat - n.lat, i[a].lng - n.lng],
		...
		_toggleCornerMarkers: function(t) {
			for (var e = 0,
			i = this._resizeMarkers.length; e < i; e++) this._resizeMarkers[e].setOpacity(t)
		},
	...
	function() {
		...
		L.GeometryUtil = L.extend(L.GeometryUtil || {},
		{
			...
			readableArea: function(e, i, o) {
				var n, s, o = L.Util.extend({},
				t, o);
				return i ? (s = ["ha", "m"], type = typeof i, "string" === type ? s = [i] : "boolean" !== type && (s = i), n = e >= 1e6 && -1 !== s.indexOf("km") ? L.GeometryUtil.formattedNumber(1e-6 * e, o.km) + " kmÂ²": e >= 1e4 && -1 !== s.indexOf("ha") ? L.GeometryUtil.formattedNumber(1e-4 * e, o.ha) + " ha": L.GeometryUtil.formattedNumber(e, o.m) + " mÂ²") : (e /= .836127, n = e >= 3097600 ? L.GeometryUtil.formattedNumber(e / 3097600, o.mi) + " miÂ²": e >= 4840 ? L.GeometryUtil.formattedNumber(e / 4840, o.ac) + " acres": L.GeometryUtil.formattedNumber(e, o.yd) + " ydÂ²"),
				n
			},
			readableDistance: function(e, i, o, n, s) {
				var a, s = L.Util.extend({},
				t, s);
				...
				default:
					e *= 1.09361,
					a = e > 1760 ? L.GeometryUtil.formattedNumber(e / 1760, s.mi) + " miles": L.GeometryUtil.formattedNumber(e, s.yd) + " yd"
				}
				return a
			}
		})
	...
	L.Toolbar = L.Class.extend({
		...
		addToolbar: function(t) {
			...
			if (o) return this._lastButtonIndex = --o,
		...
		removeToolbar: function() {
			...
			this._modes = {};
			for (var e = 0,
			i = this._actionButtons.length; e < i; e++) this._disposeButton(this._actionButtons[e].button, this._actionButtons[e].callback, this);
			this._actionButtons = [],
		...
		_createButton: function(t) {
			...
			L.DomEvent.on(e, "click", L.DomEvent.stopPropagation).on(e, "mousedown", L.DomEvent.stopPropagation).on(e, "dblclick", L.DomEvent.stopPropagation).on(e, "touchstart", L.DomEvent.stopPropagation).on(e, "click", L.DomEvent.preventDefault).on(e, "click", t.callback, t.context),
			e
		},
	...
	L.EditToolbar = L.Toolbar.extend({
		...
		initialize: function(t) {
			t.edit && (void 0 === t.edit.selectedPathOptions && (t.edit.selectedPathOptions = this.options.edit.selectedPathOptions), t.edit.selectedPathOptions = L.extend({},
			this.options.edit.selectedPathOptions, t.edit.selectedPathOptions)),
			t.remove && (t.remove = L.extend({},
			this.options.remove, t.remove)),
			t.poly && (t.poly = L.extend({},
			this.options.poly, t.poly)),
	...
	L.EditToolbar.Edit = L.Handler.extend({
		...
		_enableLayerEdit: function(t) {
			...
			this.options.selectedPathOptions), e.maintainColor && (e.color = o.options.color, e.fillColor = o.options.fillColor), o.options.original = L.extend({},
			o.options), o.options.editing = e),
